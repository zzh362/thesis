...
\caption{SAKM-PSD 整体架构示意图 \\Fig~\ref{fig_pip2}~The overall framework of the proposed SAKM-PSD}
\label{fig_pip2}
\end{figure}
...
\caption{结构感知 CutMix 策略示意图 \\Fig~\ref{fig_cutmix}~Schematic of the proposed Structure-Aware CutMix strategy}
\label{fig_cutmix}
\end{figure}
...
\caption{注意力引导插值（AGI）模块示意图 \\Fig~\ref{fig_agi}~Schematic of the Attention-Guided Interpolation (AGI)}
\label{fig_agi}
\end{figure}
...
\caption{代表性场景下的可视化检测性能展示 \\Fig~\ref{fig_res2}~Visualized detection performance in representative scenarios}
\label{fig_res2}
\end{figure}
